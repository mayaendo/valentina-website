...
const enBioBottom = `<p>Over the years, I&rsquo;ve been part of a wide variety of recording sessions, from large-scale live band setups to intimate acoustic projects. My deep connection with Jazz recordings, in particular, has shaped my approach to capturing the soul and authenticity of live performances.</p>
...
<p>I&rsquo;ve had the privilege of collaborating with incredible artists internationally, including <a href="https://open.spotify.com/artist/1XSmez9xyCCPpOZp0uImwM" target="_blank" rel="noopener noreferrer">Rita Payés</a>, <a href="https://open.spotify.com/artist/0ctjXj4AKsMtj6Tsm0JzSj" target="_blank" rel="noopener noreferrer">Shai Maestro</a>, <a href="https://open.spotify.com/artist/1Ol6gp3TzxunLVbg8GiOLZ" target="_blank" rel="noopener noreferrer">Brisa</a>, <a href="https://open.spotify.com/artist/05swzPCeWZMjApcUBYLyyi" target="_blank" rel="noopener noreferrer">Maya Endo</a>, <a href="https://open.spotify.com/artist/0rZ7WVov40lMe09hc7BXW0" target="_blank" rel="noopener noreferrer">Allexa Nava</a>, <a href="https://open.spotify.com/artist/34c3b95E9ZQPMPapPOv8RW" target="_blank" rel="noopener noreferrer">Hohnen Ford</a>, <a href="https://open.spotify.com/artist/5rCTkyHZUIUcPwKwIz8YOg" target="_blank" rel="noopener noreferrer">aron!</a>, and many others. Whether behind the console or in the songwriting process, I strive to bring each artist's unique vision to life and create music that resonates deeply.</p>`;

const esBioTop = `<p>Soy ingeniera de grabación, productora y compositora, originalmente tanto de Perú como de Italia. Actualmente, trabajo como Asistente de Ingeniería en el reconocido estudio <a href="https://www.soldesants.com" target="_blank" rel="noopener noreferrer">Sol de Sants</a> en Barcelona, bajo la mentoría de <a href="https://www.soldesants.com/the-team/" target="_blank" rel="noopener noreferrer">Alberto Perez</a>.</p>
<p>Perfeccioné mi oficio como ingeniera de sonido bajo la tutela de <a href="https://sites.gold.ac.uk/goldsmiths-music-studios/engineers/" target="_blank" rel="noopener noreferrer">Mikko Gordon</a>, <a href="https://sites.gold.ac.uk/goldsmiths-music-studios/engineers/" target="_blank" rel="noopener noreferrer">Sean Woodlock</a>, y <a href="https://sites.gold.ac.uk/goldsmiths-music-studios/engineers/" target="_blank" rel="noopener noreferrer">Nick Powell</a> en <a href="https://sites.gold.ac.uk/goldsmiths-music-studios/" target="_blank" rel="noopener noreferrer">Goldsmiths Music Studios</a> en Londres, a la par trabajando como Ingeniera Asistente en <a href="https://www.lightship95.com" target="_blank" rel="noopener noreferrer">Lightship95 Studios</a>. Allí, comencé como practicante para <a href="https://www.lightship95.com/giles" target="_blank" rel="noopener noreferrer">Giles Barret</a> y <a href="https://www.lightship95.com/dave" target="_blank" rel="noopener noreferrer">Dave Holmes</a>, donde adquirí experiencia valiosa sobre los estándares de la industria musical, y desarrollé las habilidades necesarias para desenvolverme con confianza en entornos profesionales y sesiones comerciales.</p>
<p>También he contribuido en proyectos en <a href="https://www.studiohighwater.co.uk" target="_blank" rel="noopener noreferrer">Studio Highwater</a>, <a href="https://zigzagrecording.com" target="_blank" rel="noopener noreferrer">ZigZag Studios</a> y <a href="https://www.instagram.com/alcanfores_/" target="_blank" rel="noopener noreferrer">Alcanfores Estudio</a>.</p>`;

const esBioBottom = `<p>A lo largo de los años, he participado en una gran variedad de sesiones de grabación, incluyendo formatos grandes de bandas en vivo como también proyectos acústicos íntimos. Mi conexión profunda con las grabaciones de Jazz, en particular, ha dado forma a mi enfoque para capturar el alma y la autenticidad de las interpretaciones en vivo.</p>
<p>Mi formación musical como flautista de Jazz y música Clásica me proporciona un oído versátil y una base sólida para crear paisajes sonoros únicos. Esto ha influido en mi trabajo tanto como ingeniera como colaboradora creativa, permitiéndome adaptar fácilmente a diferentes géneros y visiones artísticas.</p>
    ...
    contact: {
      ...
      form: {
        ...
        errors: {
          ...
          invalid_message: "Please write a message (at least a few sentences).",
          invalid_country: "Please enter your country or region.",
          send_failed: "The message could not be sent. Try again later.",
          not_configured:
            "Contact form is not configured (missing EmailJS environment variables).",
        },
      },
    },
  },
  es: {
    ...
    contact: {
      ...
      form: {
        ...
        errorGeneric: "Algo salió mal. Inténtalo de nuevo o escribe por correo.",
        errors: {
          invalid_name: "Introduce un nombre válido.",
          invalid_email: "Introduce un correo válido.",
          invalid_message: "Escribe un mensaje (al menos unas líneas).",
          invalid_country: "Indica tu país o región.",
          send_failed: "No se pudo enviar el mensaje. Prueba más tarde.",
          not_configured:
            "El formulario no está configurado (faltan variables de entorno de EmailJS).",
        },
      },
    },
  },
