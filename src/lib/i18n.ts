...
export const translations = {
  en: {
    ...
    hero: {
      ...
      creditKey:
        "E = Engineer · P = Production · M = Mix · MA = Mastering · AE = Assistant Engineer · SW = Songwriter",
    },
    carousels: {
  ...
  es: {
    ...
    hero: {
      ...
      creditKey:
        "E = Ingeniero/a · P = Producción · M = Mezcla · MA = Masterización · AE = Ingeniero/a Asistente · SW = Compositora",
    },
    carousels: {
